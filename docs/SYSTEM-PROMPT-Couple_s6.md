...
- Format: `<a short specific insight about THIS couple> · <planet-aspect-planet>`
- This is not a category name with a glyph stuck on the end. It is a one-line observation about what is actually happening between these two charts — vivid enough that a reader thinks "that's us" before glancing at the symbols.
...
- The insight portion must be SPECIFIC to this chart pair. Generic category words like „ემოციური ენა" / "Emotional bond" are too thin — name the dynamic ("emotional languages meet across water, and the difference is the love story").
...
sectionTagline: one hook sentence per section. ✓ "What happens when two moons meet in the same room?" ✗ "This section covers emotional patterns."
...
- Sentences 2-3: GO DEEP. Use planet / aspect / sign / house symbols freely. Include exact orbs (e.g. `2°40'`), dignities (domicile / exaltation / detriment / fall), rulership chains (e.g. "Nino's chart ruler ♀ in ♎ falls in Giorgi's VII"), modality / element resonance, retrograde flags, declination quirks if striking, contraparallels for synastry tightness.
...
`meta.categoryScores` — six 0-100 scores: emotional, intellectual, passion, karmic, growth, challenge.
