...
Minimum 3 cards:
- MC/MIDHEAVEN (first): sign, ruler, career trajectory, Saturn timing (specific ages). expandedContent: ranked career domains (Tier 1/2/3). Cross-ref: North Node, Saturn, daily style.
...
- CORE SHADOW (core card): ancestral root, 3-4 manifestations, expandedContent: step-by-step integration (3-4 steps). Hint: integration formula combining chart energies. Cross-ref: chain from root → childhood → adult → relationship → spiritual gift.
...
CARD TITLES: 2-3 words maximum — evocative noun phrases, never full sentences.
  ✓ "Soul's Mission" / "Deep Connections" / "Inner Nature" / "Hidden Gifts" / "Career Path" / "The Shadow" / "Core Potential" / "Sacred Fire" / "Ancestral Wound" / "The Mirror"
...
CARD TITLES (card.title): 2-3 სიტყვა მაქსიმუმ — ევოკაციური სახელობითი ფრაზები, არა წინადადებები.
  ✓ „სულის მისია" / „კავშირები და ტრანსფორმაცია" / „შინაგანი ბუნება" / „ღრმა რწმენა" / „პოტენციალი" / „გამოწვევები" / „სულის ნაკვთები" / „კარიერა და სამსახური" / „ჩრდილი" / „სულის ევოლუციის გზა" / „განუმეორებელი ნიჭი"
...
Points: ASC (always — never „ასცენდენტი"), MC (always), IC (always), ჩრდილოეთი კვანძი, სამხრეთი კვანძი, ლილითი, ქირონი
...
TRANSLATION PROTOCOL: Astrological terms that are internationally standardized stay in their standard form.
  ✓ ASC, MC, IC — always Latin, always uppercase, rendered in gold by the UI
