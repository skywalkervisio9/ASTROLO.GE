...
const FACTS: Record<Language, string[]> = {
  ka: [
    ...
    'კომპოზიტური რუკა ორი ადამიანის საშუალო წერტილებით იქმნება — ურთიერთობას, როგორც ცალკე არსებას, აჩვენებს.',
    'როცა ერთი პარტნიორის მზე მეორის მთვარეს ეხმიანება, ეს ღრმა ბუნებრივ თავსებადობას ქმნის.',
    'ასცენდენტების თანხვედრა ორ ადამიანს შორის მყისიერ ურთიერთმიზიდულობას იწვევს.',
    'ქირონის კონტაქტი სინასტრიაში ხშირად ნიშნავს განკურნებას ერთმანეთის მეშვეობით.',
    'სახლების გადაფარვა აჩვენებს, რომელ სფეროებში შემოაქვს პარტნიორს ენერგია შენს ცხოვრებაში.',
    'ელემენტების თავსებადობა — ცეცხლი და ჰაერი, მიწა და წყალი — ბუნებრივად კვებავს ერთმანეთს.',
    'კვინკუნქსის ასპექტი ორ რუკას შორის მუდმივ მორგებას მოითხოვს, მაგრამ ზრდას უწყობს ხელს.',
    'ვენერას შეხვედრა ორივე რუკაში ერთმანეთის ღირებულებებსა და სიყვარულის ენას აახლოებს.',
  ],
  en: [
    ...
    "The composite chart is built from the midpoints of two people's planets — it shows the relationship as its own entity.",
    "When one partner's Sun aligns with the other's Moon, it creates a deep natural compatibility.",
    'Matching ascendants between two people often spark instant mutual attraction.',
    'A Chiron contact in synastry often points to healing through one another.',
    "House overlays show which areas of your life your partner's planets activate.",
    'Complementary elements — fire with air, earth with water — naturally fuel each other.',
    'A quincunx aspect between two charts demands constant adjustment but fuels growth.',
    'A mutual Venus contact between two charts aligns shared values and love languages.',
  ],
};
